...
load Single_divide;
CV = 10;
Drg_metrics = cross_validation(Drg_Divide,CV);
results = Metrics_analysis(Drg_metrics);
end
...
for divideIndex = 1 : num_div
    ...
    for cv = 1:CV
        ...
        %First parameter of LapRLS_dru replace with K1, K2, K3 and K_COM2
        score_matrix = LapRLS_dru(K1,train_interaction_matrix,lamuda);     %Change the first parameter
