...
grid on
h2 = legend({'SKF AUROC = 0.887','Association Similarity AUROC = 0.811','Functional Similarity AUROC = 0.804','Chemical Similarity AUROC = 0.778'});
...
grid on
h2 = legend({'SKF AUPR = 0.455','Association Similarity AUPR = 0.161','Functional Similarity AUPR = 0.112','Chemical Similarity AUPR = 0.092'});
set(h2,'FontName','Times New Roman','FontSize',10)
